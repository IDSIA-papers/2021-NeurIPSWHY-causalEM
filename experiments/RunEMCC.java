...
public class RunEMCC implements Runnable{
	...
	public static experiments.RunEMCC exp;
	...
	public static void main(String[] args) {
		...
		CommandLine.run(new experiments.RunEMCC(), args);
		if(errMsg!="")
			System.exit(-1);
	...
	public void run(){
		...
		try {
			...
			exp = this;
			invoker.run(experiments.RunEMCC::pipline, timeout);
		}catch (Exception e){
			errMsg = e.toString();
